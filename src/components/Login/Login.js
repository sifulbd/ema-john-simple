        ...
        <div className='text-center container'>
            ...
            <div className="">
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <br /> <input type="email" name='email' onBlur={handleInput} className='form-control' placeholder='Email'/> 
                  <br /> <input type="password" name='password' onBlur={handleInput} className='form-control' placeholder='Password'/> 
                  <br /> <input type="submit" value={newUser ? 'SignUp' : 'Login'} />
              </form>
